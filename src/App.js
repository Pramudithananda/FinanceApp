...
const DEFAULT_CATEGORIES = [
  { id: 1, name: '???? ????? ??????', balance: 0, target: 10000, spent: 0, unitPrice: 100 },
  { id: 2, name: '???', balance: 0, target: 15000, spent: 0, unitPrice: 200 },
  { id: 3, name: '????????', balance: 0, target: 8000, spent: 0, unitPrice: 50 },
];
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        <View style={styles.balanceContainer}>
          ...
          />
          <BalanceCard label="????? ????" amount={cashBalance} type="cash" />
        </View>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <Text style={styles.sectionTitle}>
              ?????? ?????{' '}
              <Text style={styles.sectionTitleHint}>(Tap ?????)</Text>
            </Text>
            <TouchableOpacity
