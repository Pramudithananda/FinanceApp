...
const CategoryModal = ({ 
  ...
  const handleSubmit = () => {
    ...
    if (isNaN(targetNum) || targetNum < 0) {
      alert('වලංගු ඉලක්ක මුදලක් ඇතුළත් කරන්න');
      return;
    }
        ...
        <View style={styles.modalContent}>
          <View style={styles.modalHeader}>
            <Text style={styles.modalTitle}>
              {category ? 'කාණ්ඩය Edit කරන්න' : 'නව කාණ්ඩය එකතු කරන්න'}
            </Text>
          ...
          <Text style={styles.inputLabel}>ඉලක්ක මුදල (රු)</Text>
          <TextInput
            style={styles.input}
            placeholder="ඉලක්ක මුදල ඇතුළත් කරන්න"
